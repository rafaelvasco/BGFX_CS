...
{
	public const int MAX_VIEWS = 256;
	
	private const string BGFXLibrary = "BGFX";
	...
	private static partial void bgfx_attachment_init(Attachment* _this, TextureHandle _handle, Access _access, ushort _layer, ushort _numLayers, ushort _mip, byte _resolve);
	
	public static void AttachmentInit(Attachment* attachment, TextureHandle handle, Access access, int layer, int numLayers, int mip, byte resolve) => bgfx_attachment_init(attachment, handle, access, (ushort)layer, (ushort)numLayers, (ushort)mip, resolve);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial VertexLayout* bgfx_vertex_layout_begin(VertexLayout* _this, RendererType _rendererType);
	
	public static VertexLayout* VertexLayoutBegin(VertexLayout* layout, RendererType rendererType) => bgfx_vertex_layout_begin(layout, rendererType);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial VertexLayout* bgfx_vertex_layout_add(VertexLayout* _this, Attrib _attrib, byte _num, AttribType _type, [MarshalAs(UnmanagedType.I1)] bool _normalized, [MarshalAs(UnmanagedType.I1)] bool _asInt);
	
	public static VertexLayout* VertexLayoutAdd(VertexLayout* layout, Attrib attribute, byte numberElements, AttribType attributeType, bool normalized, bool asInt) => bgfx_vertex_layout_add(layout, attribute, numberElements, attributeType, normalized, asInt);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_vertex_layout_decode(VertexLayout* _this, Attrib _attrib, byte * _num, AttribType* _type, bool* _normalized, bool* _asInt);
	
	public static void VertexLayoutDecode(VertexLayout* layout, Attrib attribute, out byte numElements,
		out AttribType attributeType, out bool normalized, out bool asInt)
	{
		fixed(byte* numPtr = &numElements)
		fixed(AttribType* typePtr = &attributeType)
		fixed(bool* normalizedPtr = &normalized)
		fixed (bool* asIntPtr = &asInt)
		{
			bgfx_vertex_layout_decode(layout, attribute, numPtr, typePtr, normalizedPtr, asIntPtr);
		}	
	}
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial VertexLayout* bgfx_vertex_layout_skip(VertexLayout* _this, byte _num);
	
	public static VertexLayout* VertexLayoutSkip(VertexLayout* layout, byte numberBytes) => bgfx_vertex_layout_skip(layout, numberBytes);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_vertex_layout_end(VertexLayout* _this);
	
	public static void VertexLayoutEnd(VertexLayout* layout) => bgfx_vertex_layout_end(layout);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_vertex_pack(float _input, [MarshalAs(UnmanagedType.I1)] bool _inputNormalized, Attrib _attr, VertexLayout* _layout, void* _data, uint _index);
	
	public static void VertexPack(float input, bool inputNormalized, Attrib attr, VertexLayout* layout, uint index, void* data) => bgfx_vertex_pack(input, inputNormalized, attr, layout, data, index);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_vertex_unpack(float _output, Attrib _attr, VertexLayout* _layout, void* _data, uint _index);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_vertex_convert(VertexLayout* _dstLayout, void* _dstData, VertexLayout* _srcLayout, void* _srcData, uint _num);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial uint bgfx_weld_vertices(void* _output, VertexLayout* _layout, void* _data, uint _num, [MarshalAs(UnmanagedType.I1)] bool _index32, float _epsilon);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial uint bgfx_topology_convert(TopologyConvert _conversion, void* _dst, uint _dstSize, void* _indices, uint _numIndices, [MarshalAs(UnmanagedType.I1)] bool _index32);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_topology_sort_tri_list(TopologySort _sort, void* _dst, uint _dstSize, float _dir, float _pos, void* _vertices, uint _stride, void* _indices, uint _numIndices, [MarshalAs(UnmanagedType.I1)] bool _index32);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial byte bgfx_get_supported_renderers(byte _max, RendererType* _enum);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial IntPtr bgfx_get_renderer_name(RendererType _type);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_init_ctor(InitProps* _init);
	
	public static void InitConstructor(InitProps* _init) => bgfx_init_ctor(_init);
	...
	private static partial bool bgfx_init(InitProps* _init);
	
	public static bool Init(InitProps* init) => bgfx_init(init);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_shutdown();
	
	public static void Shutdown() => bgfx_shutdown();
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_reset(uint _width, uint _height, uint _flags, TextureFormat _format);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial uint bgfx_frame( [MarshalAs(UnmanagedType.I1)]bool _capture);
	
	public static void Frame(bool capture = false)
	{
		_ = bgfx_frame(capture);
	}
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial RendererType bgfx_get_renderer_type();
	
	public static RendererType GetRendererType() => bgfx_get_renderer_type();
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial Caps* bgfx_get_caps();
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial Stats* bgfx_get_stats();
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial Memory* bgfx_alloc(uint _size);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial Memory* bgfx_make_ref_release(void* _data, uint _size, IntPtr _releaseFn, void* _userData);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_debug(uint _debug);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_dbg_text_clear(byte _attr, [MarshalAs(UnmanagedType.I1)] bool _small);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_dbg_text_printf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, [MarshalAs(UnmanagedType.LPStr)] string args );
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_dbg_text_vprintf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, IntPtr _argList);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_dbg_text_image(ushort _x, ushort _y, ushort _width, ushort _height, void* _data, ushort _pitch);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial IndexBufferHandle bgfx_create_index_buffer(Memory* _mem, ushort _flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_index_buffer_name(IndexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_index_buffer(IndexBufferHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial VertexLayoutHandle bgfx_create_vertex_layout(VertexLayout* _layout);
	
	public static VertexLayoutHandle CreateVertexLayout(VertexLayout* layout) => bgfx_create_vertex_layout(layout);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_vertex_layout(VertexLayoutHandle _layoutHandle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial VertexBufferHandle bgfx_create_vertex_buffer(Memory* _mem, VertexLayout* _layout, ushort _flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_vertex_buffer_name(VertexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_vertex_buffer(VertexBufferHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial DynamicIndexBufferHandle bgfx_create_dynamic_index_buffer(uint _num, ushort _flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial DynamicIndexBufferHandle bgfx_create_dynamic_index_buffer_mem(Memory* _mem, ushort _flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_update_dynamic_index_buffer(DynamicIndexBufferHandle _handle, uint _startIndex, Memory* _mem);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_dynamic_index_buffer(DynamicIndexBufferHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial DynamicVertexBufferHandle bgfx_create_dynamic_vertex_buffer(uint _num, VertexLayout* _layout, ushort _flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial DynamicVertexBufferHandle bgfx_create_dynamic_vertex_buffer_mem(Memory* _mem, VertexLayout* _layout, ushort _flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_update_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle, uint _startVertex, Memory* _mem);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial uint bgfx_get_avail_transient_index_buffer(uint _num, [MarshalAs(UnmanagedType.I1)] bool _index32);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial uint bgfx_get_avail_transient_vertex_buffer(uint _num, VertexLayout* _layout);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial uint bgfx_get_avail_instance_data_buffer(uint _num, ushort _stride);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_alloc_transient_index_buffer(TransientIndexBuffer* _tib, uint _num, [MarshalAs(UnmanagedType.I1)] bool _index32);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_alloc_transient_vertex_buffer(TransientVertexBuffer* _tvb, uint _num, VertexLayout* _layout);
	...
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	[return: MarshalAs(UnmanagedType.I1)]
	private static partial bool bgfx_alloc_transient_buffers(TransientVertexBuffer* _tvb, VertexLayout* _layout, uint _numVertices, TransientIndexBuffer* _tib, uint _numIndices, [MarshalAs(UnmanagedType.I1)] bool _index32);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_alloc_instance_data_buffer(InstanceDataBuffer* _idb, uint _num, ushort _stride);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial IndirectBufferHandle bgfx_create_indirect_buffer(uint _num);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_indirect_buffer(IndirectBufferHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial ShaderHandle bgfx_create_shader(Memory* _mem);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial ushort bgfx_get_shader_uniforms(ShaderHandle _handle, UniformHandle* _uniforms, ushort _max);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_shader_name(ShaderHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_shader(ShaderHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial ProgramHandle bgfx_create_program(ShaderHandle _vsh, ShaderHandle _fsh, [MarshalAs(UnmanagedType.I1)] bool _destroyShaders);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial ProgramHandle bgfx_create_compute_program(ShaderHandle _csh, [MarshalAs(UnmanagedType.I1)] bool _destroyShaders);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_program(ProgramHandle _handle);
	...
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	[return: MarshalAs(UnmanagedType.I1)]
	private static partial bool bgfx_is_texture_valid(ushort _depth, [MarshalAs(UnmanagedType.I1)] bool _cubeMap, ushort _numLayers, TextureFormat _format, ulong _flags);
	...
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	[return: MarshalAs(UnmanagedType.I1)]
	private static partial bool bgfx_is_frame_buffer_valid(byte _num, Attachment* _attachment);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_calc_texture_size(TextureInfo* _info, ushort _width, ushort _height, ushort _depth, [MarshalAs(UnmanagedType.I1)] bool _cubeMap, [MarshalAs(UnmanagedType.I1)] bool _hasMips, ushort _numLayers, TextureFormat _format);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial TextureHandle bgfx_create_texture(Memory* _mem, ulong _flags, byte _skip, TextureInfo* _info);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial TextureHandle bgfx_create_texture_2d(ushort _width, ushort _height, [MarshalAs(UnmanagedType.I1)] bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial TextureHandle bgfx_create_texture_2d_scaled(BackbufferRatio _ratio, [MarshalAs(UnmanagedType.I1)] bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial TextureHandle bgfx_create_texture_3d(ushort _width, ushort _height, ushort _depth, [MarshalAs(UnmanagedType.I1)] bool _hasMips, TextureFormat _format, ulong _flags, Memory* _mem);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial TextureHandle bgfx_create_texture_cube(ushort _size, [MarshalAs(UnmanagedType.I1)] bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_update_texture_2d(TextureHandle _handle, ushort _layer, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_update_texture_3d(TextureHandle _handle, byte _mip, ushort _x, ushort _y, ushort _z, ushort _width, ushort _height, ushort _depth, Memory* _mem);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_update_texture_cube(TextureHandle _handle, ushort _layer, byte _side, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial uint bgfx_read_texture(TextureHandle _handle, void* _data, byte _mip);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_texture_name(TextureHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void* bgfx_get_direct_access_ptr(TextureHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_texture(TextureHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial FrameBufferHandle bgfx_create_frame_buffer(ushort _width, ushort _height, TextureFormat _format, ulong _textureFlags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial FrameBufferHandle bgfx_create_frame_buffer_scaled(BackbufferRatio _ratio, TextureFormat _format, ulong _textureFlags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial FrameBufferHandle bgfx_create_frame_buffer_from_handles(byte _num, TextureHandle* _handles, [MarshalAs(UnmanagedType.I1)] bool _destroyTexture);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial FrameBufferHandle bgfx_create_frame_buffer_from_attachment(byte _num, Attachment* _attachment, [MarshalAs(UnmanagedType.I1)] bool _destroyTexture);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial FrameBufferHandle bgfx_create_frame_buffer_from_nwh(void* _nwh, ushort _width, ushort _height, TextureFormat _format, TextureFormat _depthFormat);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_frame_buffer_name(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial TextureHandle bgfx_get_texture(FrameBufferHandle _handle, byte _attachment);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_frame_buffer(FrameBufferHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial UniformHandle bgfx_create_uniform([MarshalAs(UnmanagedType.LPStr)] string _name, UniformType _type, ushort _num);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_get_uniform_info(UniformHandle _handle, UniformInfo* _info);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_uniform(UniformHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial OcclusionQueryHandle bgfx_create_occlusion_query();
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial OcclusionQueryResult bgfx_get_result(OcclusionQueryHandle _handle, int* _result);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_destroy_occlusion_query(OcclusionQueryHandle _handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_palette_color(byte _index, float _rgba);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_palette_color_rgba32f(byte _index, float _r, float _g, float _b, float _a);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_palette_color_rgba8(byte _index, uint _rgba);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_name(ushort _id, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	
	public static void SetViewName(ushort viewId, string name) => bgfx_set_view_name(viewId, name, name.Length);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_rect(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height);
	
	public static void SetViewRect(ushort viewId, int x, int y, int width, int height) => bgfx_set_view_rect(viewId, (ushort)x, (ushort)y, (ushort)width, (ushort)height);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_rect_ratio(ushort _id, ushort _x, ushort _y, BackbufferRatio _ratio);
	
	public static void SetViewRectRatio(ushort viewId, int x, int y, BackbufferRatio ratio) => bgfx_set_view_rect_ratio(viewId, (ushort)x, (ushort)y, ratio);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_scissor(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height);
	
	public static void SetViewScissor(ushort viewId, int x, int y, int w, int h) => bgfx_set_view_scissor(viewId, (ushort)x, (ushort)y, (ushort)w, (ushort)h);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_clear(ushort _id, ushort _flags, uint _rgba, float _depth, byte _stencil);
	
	public static void SetViewClear(ushort viewId, ClearFlags flags, uint rgba, float depth, byte stencil) => bgfx_set_view_clear(viewId, (ushort)flags, rgba, depth, stencil);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_clear_mrt(ushort _id, ushort _flags, float _depth, byte _stencil, byte _c0, byte _c1, byte _c2, byte _c3, byte _c4, byte _c5, byte _c6, byte _c7);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_mode(ushort _id, ViewMode _mode);
	
	public static void SetViewMode(ushort viewId, ViewMode _mode) => bgfx_set_view_mode(viewId, _mode);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_frame_buffer(ushort _id, FrameBufferHandle _handle);
	
	public static void SetViewFramebuffer(ushort viewId, FrameBufferHandle handle) => bgfx_set_view_frame_buffer(viewId, handle);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_transform(ushort _id, void* _view, void* _proj);
	
	public static void SetViewTransform(ushort viewId, float* viewTransform, float* projMatrix) => bgfx_set_view_transform(viewId, viewTransform, projMatrix);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_view_order(ushort _id, ushort _num, ushort* _order);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_reset_view(ushort _id);
	
	public static void ResetView(ushort viewId) => bgfx_reset_view(viewId);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_request_screen_shot(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _filePath);
	
	public static void RequestScreenshot(FrameBufferHandle frameBuffer, string filePath) => bgfx_request_screen_shot(frameBuffer, filePath);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial RenderFrameState bgfx_render_frame(int _msecs);
	
	public static RenderFrameState RenderFrame(int _msecs) => bgfx_render_frame(_msecs);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_platform_data(PlatformData* _data);
	
	public static void SetPlatformData(PlatformData* _data) => bgfx_set_platform_data(_data);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial UIntPtr bgfx_override_internal_texture_ptr(TextureHandle _handle, UIntPtr _ptr);
	
	public static UIntPtr OverrideInternalTexturePtr(TextureHandle textureHandle, UIntPtr ptr) => bgfx_override_internal_texture_ptr(textureHandle, ptr);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial UIntPtr bgfx_override_internal_texture(TextureHandle _handle, ushort _width, ushort _height, byte _numMips, TextureFormat _format, ulong _flags);
	
	public static UIntPtr OverrideInternalTexture(TextureHandle texture, int width, int height, byte numMips, TextureFormat format, ulong flags) => bgfx_override_internal_texture(texture, (ushort)width, (ushort)height, numMips, format, flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_state(ulong _state, uint _rgba);
	
	public static void SetState(StateFlags _state, uint _rgba) => bgfx_set_state((ulong)_state, _rgba);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_uniform(UniformHandle _handle, void* _value, ushort _num);
	
	public static void SetUniform(UniformHandle uniform, void* value, ushort num) => bgfx_set_uniform(uniform, value, num);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_index_buffer(IndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	
	public static void SetIndexBuffer(IndexBufferHandle indexBuffer, int firstIndex, int numIndices) => bgfx_set_index_buffer(indexBuffer, (uint)firstIndex, (uint)numIndices);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_dynamic_index_buffer(DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	
	public static void SetDynamicIndexBuffer(DynamicIndexBufferHandle indexBuffer, int firstIndex, int numIndices) => bgfx_set_dynamic_index_buffer(indexBuffer, (uint)firstIndex, (uint)numIndices);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_transient_index_buffer(TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices);
	
	public static void SetTransientIndexBuffer(TransientIndexBuffer* indexBuffer, int firstIndex, int numIndices) => bgfx_set_transient_index_buffer(indexBuffer, (uint)firstIndex, (uint)numIndices);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_vertex_buffer(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	
	public static void SetVertexBuffer(byte stream, VertexBufferHandle vertexBuffer, int startVertex, int numVertices) => bgfx_set_vertex_buffer(stream, vertexBuffer, (uint)startVertex, (uint)numVertices);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_dynamic_vertex_buffer(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	
	public static void SetDynamicVertexBuffer(byte stream, DynamicVertexBufferHandle vertexBuffer, int startVertex, int numVertices) => bgfx_set_dynamic_vertex_buffer(stream, vertexBuffer, (uint)startVertex, (uint)numVertices);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_transient_vertex_buffer(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices);
	
	public static void SetTransientVertexBuffer(byte stream, TransientVertexBuffer* vertexBuffer, int startVertex, int numVertices) => bgfx_set_transient_vertex_buffer(stream, vertexBuffer, (uint)startVertex, (uint)numVertices);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_set_texture(byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags);
	
	public static void SetTexture(byte stage, UniformHandle sampler, TextureHandle texture, TextureFlags flags) => bgfx_set_texture(stage, sampler, texture, (uint)flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_touch(ushort _id);
	
	public static void Touch(ushort viewId) => bgfx_touch(viewId);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_submit(ushort _id, ProgramHandle _program, uint _depth, byte _flags);
	
	public static void Submit(ushort viewId, ProgramHandle program, uint depth, DiscardFlags _flags) => bgfx_submit(viewId, program, depth, (byte)_flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_discard(byte _flags);
	
	public static void Discard(DiscardFlags flags) => bgfx_discard((byte)flags);
	...
	///
	[LibraryImport(BGFXLibrary), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	private static partial void bgfx_blit(ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY, ushort _dstZ, TextureHandle _src, byte _srcMip, ushort _srcX, ushort _srcY, ushort _srcZ, ushort _width, ushort _height, ushort _depth);
	
	public static void Blit(ushort viewId, TextureHandle destination, byte dstMip, int dstX, int dstY, TextureHandle source, byte srcMip, int srcX, int srcY, int width, int height) => bgfx_blit(viewId, destination, dstMip, (ushort)dstX, (ushort)dstY, 0, source, srcMip, (ushort)srcX, (ushort)srcY, 0, (ushort)width, (ushort)height, 0);
}
